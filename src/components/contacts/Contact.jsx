...
// 3D Floating Message Icon (without drei/Text)
function FloatingMessageIcon({ position, color, rotationSpeed }) {
...
const Contact = () => {
  ...
  return (
    <section
      id="contact-us"
      className="min-h-screen py-16 bg-gradient-to-b from-gray-900 to-gray-950 text-white overflow-hidden relative"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h5 className="text-indigo-400 text-lg md:text-xl font-medium mb-2">
            Get in Touch
          </h5>
          <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-white to-indigo-200 bg-clip-text text-transparent">
            Contact Me
          </h2>
        </div>
